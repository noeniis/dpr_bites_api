...
$id_users = isset($payload['id_users'])?(int)$payload['id_users']:0;
...
if($id_transaksi<=0||$id_users<=0){echo json_encode(['success'=>false,'message'=>'id_transaksi & id_users wajib']);exit;}
...
$sqlC = "SELECT id_gerai,status FROM transaksi WHERE id_transaksi=$id_transaksi LIMIT 1";
